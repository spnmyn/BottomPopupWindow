...
public class BottomPopupWindowView extends LinearLayout {
    ...
    public BottomPopupWindowView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        base_view = bottomPopupView.findViewById(R.id.bottom_view);
        content_view = bottomPopupView.findViewById(R.id.content_view);
        popup_bg = bottomPopupView.findViewById(R.id.popup_bg);
        ...
        animation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(
                        RelativeLayout.LayoutParams.MATCH_PARENT, getViewHeight(BottomPopupWindowView.this));
